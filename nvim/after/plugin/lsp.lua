local on_attach = function(_, bufnr)
	...
	-- Go to declaration
	bufmap("<leader>g", vim.lsp.buf.declaration)
	...
	bufmap("<C-k>", '<cmd>lua vim.diagnostic.goto_next({ border = "rounded" })<CR>')
	bufmap("<C-j>", '<cmd>lua vim.diagnostic.goto_prev({ border = "rounded" })<CR>')
